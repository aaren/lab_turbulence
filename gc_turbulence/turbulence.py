...
@parallel_stub
def file_to_array(fname, columns, skip_header, delimiter=None):
...
class SingleLayerRun(object):
    ...
    """
    # column names from the text files exported by Dynamic Studio.
    # Single camera (2d) and two camera (3d) have different headers
    ...
    columns_2d = ['ix',         # horizontal index
                  'iz',         # vertical index
                  'x_pix',      # horizontal position (pixels)
                  'z_pix',      # vertical position (pixels)
                  'x',          # horizontal position (mm)
                  'z',          # vertical position (mm)
                  'u_pix',      # horizontal velocity (pixels / s)
                  'w_pix',      # vertical velocity (pixels / s)
                  'u',          # horizontal velocity (m / s)
                  'w',          # vertical velocity (m / s)
                  'magnitude',  # length (m / s)
                  'status',     # status code
                  ]

    columns_3d = ['ix',         # horizontal index
                  'iz',         # vertical index
                  'x',          # horizontal position (mm)
                  'z',          # vertical position (mm)
                  'u',          # horizontal velocity (m / s)
                  'w',          # vertical velocity (m / s)
                  'v',          # perpendicular velocity (m / s)
                  'magnitude',  # length (m / s)
                  'status',     # status code
                  ]
